...
impl Span {
	...
	pub fn set_start(&mut self, start: usize) {
		self.start = start;
		self.end = core::cmp::max(start, self.end);
	}
	...
	pub fn set_end(&mut self, end: usize) {
		self.end = core::cmp::max(self.start, end);
	}
	...
	pub fn append(&mut self, other: Self) {
		self.start = core::cmp::min(self.start, other.start);
		self.end = core::cmp::max(self.end, other.end)
	}
	...
	pub fn inter(&self, other: Self) -> Self {
		...
		Self {
			start,
			end: core::cmp::max(start, core::cmp::min(self.end, other.end)),
		}
	}
